  ...
  return (
    <div>
      <div className='flex flex-row h-14 items-center fixed w-full top-0 z-50'>
        ...
        <Link to ='/'><div className='text-gray-300 text-4xl mr-auto cursor-pointer font-bold'>123  </div></Link>
        ...
        <div className='flex w-1/2 h-full flex-row items-center justify-between'>
          ...
          <div className='flex flex-row'>
            ...
            <Link to ='/wishlist'>   <FaHeart className='text-2xl mr-10 text-gray-300' /></Link>
            <Link to ='/cart'><FaShoppingCart className='text-2xl mr-10 text-gray-300' /></Link>
         <div>
            <Link to ='/login'><FiLogOut className='text-2xl mr-10 text-gray-300' /></Link>
            </div>
          </div>
        </div>
      </div>
