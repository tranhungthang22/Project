                ...
                <div key={item?.id} className='flex flex-row hover:border p-2 mb-6'>
                  ...
                  <div className='ml-4 w-full'>
                    ...
                    <div className='flex flex-row mt-4'>
                      ...
                      <div onClick={onRemoveCart(e)} className='bg-gray-800 h-8 rounded px-2 flex justify-center items-center uppercase text-white cursor-pointer'>Remove</div>
                    </div>
                  </div>
                </div>
              );
